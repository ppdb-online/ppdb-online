...
// Upload gambar untuk Screenshoot
function UploadScreenshoot($fupload_name){
  //direktori gambar
  $vdir_upload = "../../../screenshoot/";
  $vfile_upload = $vdir_upload . $fupload_name;
  $imageType = $_FILES["fupload"]["type"];
  ...
  //Simpan dalam versi besar 350 pixel
  //Set ukuran gambar hasil perubahan
  if($src_width>=350){
  $dst_width = 350;
  } else {
...
function Uploadiklantengah($fupload_name){
 ...
 //BUAT IKLAN ATAS
function UploadTagline($fupload_name){
  //direktori Tagline
  $vdir_upload = "../../../foto_tagline/";
  $vfile_upload = $vdir_upload . $fupload_name;
