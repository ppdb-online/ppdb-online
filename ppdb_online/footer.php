		...
		?>
					...
					<div class="footer-content">
						...
						<div class="footer-menu">
							<ul>
								 <?php    
		$sq = mysql_query("SELECT id_parent from kategori where id_parent='$_GET[id]'");
  		$n = mysql_fetch_array($sq);           
        $khusus=mysql_query("SELECT * FROM kategori WHERE aktif='Y' AND id_parent='$n[id_parent]' Order By id_kategori DESC LIMIT 9");
		 while($k=mysql_fetch_array($khusus)){
...
?>
						...
						<div class="right">Developed by <a href="http://imagomedia.co.id/" target="_blank"><img src="images/logo.png" width="124" height="61" alt="Imago Media" /></a></div>
