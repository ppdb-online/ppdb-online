...
<div class="content-panel">
	...
	<b><span class="icon-text">&#128206;</span>Berita</b>
	<div class="top-right"><a href="semua-berita.html">Lihat Semua Berita</a></div>
	</div>
  ...
  <?php
 	...
 	$terkini=mysql_query("SELECT * FROM berita WHERE id_kategori=1 AND headline='N' AND breaking_news='N' ORDER BY id_berita DESC LIMIT 2");	
