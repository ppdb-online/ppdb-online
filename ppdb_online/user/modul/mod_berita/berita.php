...
switch($_GET[act]){
  ...
  echo"<div class='rightpanel'>
    ...
    $tampil=mysql_query("SELECT * FROM berita WHERE username='$_SESSION[namauser]' ORDER BY id_berita DESC");}
						   $no = 1;
               ...
               <div class='widgetbox box-inverse'>
				...
				<form class='stdform stdform2' method=POST action='$aksi?module=berita&act=input' enctype='multipart/form-data'>
							...
							<p>
								...
								{
								$tampil=mysql_query("SELECT * FROM kategori WHERE username='$_SESSION[namauser]' ORDER BY nama_kategori");
   								while($r=mysql_fetch_array($tampil)){
		   						echo "<option value=$r[id_kategori]>$r[nama_kategori]</option></p>"; 
   								}
								echo "</select></p>";
   ...
   echo "<p>
                                <label>Isi Berita</label>
								 <span class='field'><textarea name='isi_berita'  id='tinyeditor'  placeholder='Enter text ...' style='width: 750px; height: 400px'></textarea></span>
                            </p>
 ...
 $edit = mysql_query("SELECT * FROM berita WHERE id_berita='$_GET[id]'");
   ...
   echo "
                            ...
                            <p>
                                <label>Isi Berita</label>
								 <span class='field'><textarea  name='isi_berita' id='tinyeditor' style='width: 750px; height: 400px'>$r[isi_berita]</textarea></span>
                            </p>
