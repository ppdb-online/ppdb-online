...
<table id='dyntable' class='table table-bordered'>
   ...
   <tbody>";
	  ...
	  if ($_SESSION[leveluser]=='admin'){
      $tampil = mysql_query("SELECT * FROM blogsiswa ORDER BY id_blogsiswa DESC");
    }
    else{
      $tampil=mysql_query("SELECT * FROM blogsiswa
  ...
  break;
  case "editblogsiswa":
    $edit = mysql_query("SELECT * FROM blogsiswa WHERE id_blogsiswa='$_GET[id]'");
