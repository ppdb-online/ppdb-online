    ...
    echo"<div class='rightpanel'>
       ...
       <div class='maincontent'>
		...
		<p> 
		 ...
		 <span class='field'><textarea name='isi_info' id='tinyeditor'  placeholder='Enter text ...' style='width: 750px; height: 400px'></textarea></span>
		 </p>
         <p>
		 <label>Isi Informasi PPDB</label>
  ...
  case "editinfo":
   ...
   echo"<div class='rightpanel'>
       ...
       <div class='maincontent'>
		...
		<p> 
         <label>Isi Informasi PPDB</label>
		 <span class='field'><textarea name='isi_info' id='tinyeditor'  placeholder='Enter text ...' style='width: 750px; height: 400px'>$r[isi_info]</textarea></span>
		 </p>";
          if ($r[gambar]!=''){
              echo "<p>
		 <label>Gambar</label>
