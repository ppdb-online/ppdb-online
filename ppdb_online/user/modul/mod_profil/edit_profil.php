...
switch($_GET[act]){
  // Tampil Berita
  default:
  $edit = mysql_query("SELECT * FROM halamanstatis WHERE judul_seo='$_GET[judul]'");
				...
				<input type=hidden name=id value=$r[id_halaman]>
                            ...
                            <p>
                                <label>Isi Profil</label>
								 <span class='field'><textarea  name='isi_halaman' id='tinyeditor' style='width: 750px; height: 400px'>$r[isi_halaman]</textarea></span>
                            </p>
