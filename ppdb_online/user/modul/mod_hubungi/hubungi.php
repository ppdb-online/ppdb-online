   ...
   <tbody>";
    ...
    while ($r=mysql_fetch_array($tampil)){
      ...
      echo "<tr><td>$no</td>
                ...
                <td>$tgl</a></td>
				<td width=80>   
				<a href=javascript:confirmdelete('$aksi?module=hubungi&act=hapus&id=$r[id_hubungi]')  title='Hapus' class='btn btn-danger btn-circle'><span class='iconfa-remove'></span></a>
       ...
       <div class='pageheader'>
		...
		<div class='maincontent'>
            <div class='maincontentinner'>
	           ...
	           <form class='stdform stdform2' method=POST action='?module=hubungi&act=kirimemail'>
