...
switch($_GET[act]){
  ...
  echo"<div class='rightpanel'>
   ...
   <tbody>";
    ...
    $tampil=mysql_query("SELECT * FROM agenda WHERE username='$_SESSION[namauser]' ORDER BY id_berita DESC");}
	 $no = $posisi+1;
  ...
  <span class='field'><textarea name='isi_agenda' style='width: 720px; height: 350px;'></textarea></span>
   </p> 		 
  ...
  <form class='stdform stdform2' method=POST action='$aksi?module=agenda&act=update' enctype='multipart/form-data'>
   ...
   <p> 
   <label>Isi Agenda</label>
  <span class='field'><textarea name='isi_agenda' style='width: 720px; height: 350px;'>$r[isi_agenda]</textarea>
   </p> 	
