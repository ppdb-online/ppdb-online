...
switch($_GET[act]){
  ...
  <tbody>";
   ...
   $tampil=mysql_query("SELECT * FROM berita,komentar WHERE komentar.id_berita=berita.id_berita AND berita.username='$_SESSION[namauser]' ORDER BY id_komentar DESC");
    $no = $posisi+1;
  ...
  echo"<div class='rightpanel'>
   ...
   <span class='field'><textarea name='isi_komentar' id='tinyeditor' style='width: 750px; height: 200px'>$r[isi_komentar]</textarea>
   </p>";
