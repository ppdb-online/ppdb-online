...
if ($module=='daya_tampung' AND $act=='hapus'){
  $data=mysql_fetch_array(mysql_query("SELECT gambar FROM daya_tampung WHERE id_halaman='$_GET[id]'"));
  if ($data['gambar']!=''){
     mysql_query("DELETE FROM daya_tampung WHERE id_halaman='$_GET[id]'");
...
elseif ($module=='daya_tampung' AND $act=='input'){
  ...
  if (!empty($lokasi_file)){
    ...
    mysql_query("INSERT INTO daya_tampung(judul,
                                    isi_halaman,
                                    tgl_posting,
                                    gambar) 
                            VALUES('$_POST[judul]',
...
elseif ($module=='daya_tampung' AND $act=='update'){
  ...
  header('location:../../media.php?module='.$module);
    ...
    UploadBanner($nama_file);
    mysql_query("UPDATE daya_tampung SET judul       = '$_POST[judul]',
